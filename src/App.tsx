...
export default function App() {
    ...
    createEffect(() => {
        document.body.style.overflow = showAbout()
            ? "hidden"
            : "";
    });
        ...
        <div class="container" dir={dir}>
            <div classList={{ header: true, hidden: isVisible() === 0 || isVisible() === 3, semi: isVisible() === 2 || isVisible() === 3 }}>
                ...
                <div class="center" style={view() === "home" ? "gap: 0;" : ""}>
                    <img
                        ...
                        onClick={() => {
                            view() !== "home" ? setView("home") : setShowAbout(true);
                        }}
                        aria-label={view() === "home" ? "About this website" : ""}
                    />
            ...
            <Show when={showAbout()}>
                ...
                >
                    ...
                    >
                        <div class="about back" onClick={() => setShowAbout(false)}
                        >
                            <button
                                class="jump"
                            >
                        ...
                        <h2>MYC Halifax 2026</h2>

                        <p>
                            Designed and developed by <a href="https://github.com/PeterNjeim/">Peter&nbsp;Njeim</a> for the
                            Maronite Youth Convention team.
                        </p>

                        <p class="thanks">
                            Special thanks to the volunteers, organizers, and clergy who helped make this event possible.
                        </p>

                        <p class="copyright">
                            Schedule and event information:
                            <br />
                            © MYC Canada and respective organizers.
                        </p>

                        <p class="copyright">
                            Website software and design:
                            <br />
                            © 2026 Peter Njeim. All rights reserved.
                        </p>
                        ...
                        <p class="version">
                            Version <a href="https://github.com/PeterNjeim/myc_halifax_2026-website/">1.0.68</a>
                        </p>
                    </div>
                </div>
            </Show>
